...
\section*{CRR (CCR) model DEA – matematična formulacija}
...
\section*{Malmquistov indeks produktivnosti}
...
%%%% od tu naprej je oO-vbt-Oo tekst
\section{Slovenija}
\subsection{Javna poraba}
...
\begin{figure}[H]   % 'h' pomeni "here" - da se slika vstavi približno tukaj
    ...
    \caption{Javna poraba za javno zdravstvo v Sloveniji (v milijardah USD), prilagojena za inflacijo, skozi čas}   % podnaslov slike (ni obvezno)
...
Rast BDP na prebivalca v letih do krize se ujema tudi z večanjem učinkovitosti zdravstva, prvi padec BDP-ja v letih 2009 in 2010 pa se pri CRR indeksu še ne pozna. 
...
Ob kriznem delovanju so se povečala tveganja povezana s korupcijo, opazili so netransparentnost pri naročilih in pogrešali več objavljenih podatkov o izvedenih naročilih. \cite{analizaJavnegaZdravstva2023} \\
